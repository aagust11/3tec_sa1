...
export async function laboratoryPage(id,{main,header,esc,get,current}){
 ...
 renderModel();table();if(selected.id==='flexio')mountRuler(main.querySelector('#ruler-activity'),journal,esc,persist);main.querySelector('#reset-controls').onclick=renderModel;
