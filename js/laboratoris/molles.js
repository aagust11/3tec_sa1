...
export function mount(root){
 ...
 function draw(){
  ...
  root.querySelector('.lab-visual').innerHTML=graph(`<path d="M170 50H330" stroke="#697d5a" stroke-width="9"/><path d="M200 170H380" stroke="#8d9881" stroke-dasharray="5 5"/><polyline points="${points}" fill="none" stroke="#667b58" stroke-width="4"/><rect x="232" y="${bottom}" width="36" height="24" rx="4" fill="#d1dcbf" stroke="#667b58"/>${force>0?`<path d="M250 ${bottom+25}v25" stroke="#a52c36" stroke-width="3" marker-end="url(#model-arrow)"/>`:''}<path d="M345 170V${bottom}" stroke="#a52c36" stroke-width="2"/><text x="360" y="${180+x*4}" fill="#87313b" font-size="14">x = ${x.toFixed(1)} cm</text><text x="28" y="306" font-size="12">Línia discontínua: extrem sense càrrega</text>`);
