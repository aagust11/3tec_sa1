...
El laboratori de flexió calcula la fletxa central en mm amb δ = FL³/(48EI), I = bh³/12 i E segons el material seleccionat (valors orientatius). Converteix cm a mm i GPa a N/mm². Biga simplement recolzada, càrrega central, sense pes propi i petites deformacions. La representació gràfica és exagerada i limitada, però el valor calculat i les proves registrades no es retallen. Referència de la fórmula: https://engineering.purdue.edu/~ce474/Docs/DA6-BeamFormulas.pdf .

Materials del laboratori de flexió: acer 200 GPa, alumini 70 GPa, fusta amb fibra longitudinal 10 GPa i metacrilat PMMA 3,3 GPa. La comparació relativa manté com a referència fixa la biga d’acer inicial. Cada prova conserva el material i E; els registres antics no s’alteren. Fonts dels valors representatius: MIT, taula 9.1 (https://ocw.mit.edu/ans7870/resources/woodson/textbook/emd_part3.pdf); Ansys, propietats de fusta paral·lela a la fibra (https://ansyshelp.ansys.com/public/Views/Secured/corp/v252/en/motion_theory/motion_theory_materials.html); Röhm, PMMA 3300 MPa (https://www.plexiglas-polymers.com/en/products/plexiglas-r-proterra-8n).

## Raonament guiat als laboratoris

Les sis guies inicials són a `continguts/guies-laboratori.json`: situacions A/B, condicions constants, tres decisions amb opcions (inclosa la incertesa), frase de suport i conclusió vinculada a dades concretes. «Prepara A/B» configura el model però no registra automàticament cap prova. Les previsions antigues es conserven; les seleccions noves s’afegeixen a `experiments[id].guidance` i al quadern. El regle també té preguntes prèvies sobre orientació, variables constants i observació de flexió o bolcat.
